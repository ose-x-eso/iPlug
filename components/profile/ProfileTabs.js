    ...
    <div className="profile-tabs-container" style={{ marginTop: '2rem' }}>
      ...
      <div className="profile-tabs" style={{ 
        ...
        <button 
          ...
          style={{
            background: activeTab === 'plugs' ? 'var(--accent-flat)' : 'var(--bg-input)',
            border: 'none',
            padding: '0.75rem 1.5rem',
            borderRadius: '100px',
            fontSize: '0.95rem',
            fontWeight: '600',
            color: activeTab === 'plugs' ? 'var(--bg-page)' : 'var(--text-secondary)',
            cursor: 'pointer',
        ...
        <button 
          ...
          style={{
            background: activeTab === 'reviews' ? 'var(--accent-flat)' : 'var(--bg-input)',
            border: 'none',
            padding: '0.75rem 1.5rem',
            borderRadius: '100px',
            fontSize: '0.95rem',
            fontWeight: '600',
            color: activeTab === 'reviews' ? 'var(--bg-page)' : 'var(--text-secondary)',
            cursor: 'pointer',
            transition: 'all 0.3s cubic-bezier(0.4, 0, 0.2, 1)',
            whiteSpace: 'nowrap',
            display: 'flex',
        ...
        <button 
          ...
          style={{
            background: activeTab === 'photos' ? 'var(--accent-flat)' : 'var(--bg-input)',
            border: 'none',
            padding: '0.75rem 1.5rem',
            borderRadius: '100px',
            fontSize: '0.95rem',
            fontWeight: '600',
            color: activeTab === 'photos' ? 'var(--bg-page)' : 'var(--text-secondary)',
            cursor: 'pointer',
            transition: 'all 0.3s cubic-bezier(0.4, 0, 0.2, 1)',
            whiteSpace: 'nowrap',
            display: 'flex',
        ...
        {isOwner && (
          <button 
            ...
            style={{
              background: activeTab === 'recommendations' ? 'var(--accent-flat)' : 'var(--bg-input)',
              border: 'none',
              padding: '0.75rem 1.5rem',
              borderRadius: '100px',
              fontSize: '0.95rem',
              fontWeight: '600',
              color: activeTab === 'recommendations' ? 'var(--bg-page)' : 'var(--text-secondary)',
              cursor: 'pointer',
              transition: 'all 0.3s cubic-bezier(0.4, 0, 0.2, 1)',
              whiteSpace: 'nowrap',
              display: 'flex',
        ...
        <button 
          ...
          style={{
            background: activeTab === 'portfolio' ? 'var(--accent-flat)' : 'var(--bg-input)',
            border: 'none',
            padding: '0.75rem 1.5rem',
            borderRadius: '100px',
            fontSize: '0.95rem',
            fontWeight: '600',
            color: activeTab === 'portfolio' ? 'var(--bg-page)' : 'var(--text-secondary)',
            cursor: 'pointer',
            transition: 'all 0.3s cubic-bezier(0.4, 0, 0.2, 1)',
            whiteSpace: 'nowrap',
            display: 'flex',
